        ...
        while (devam == 1) {
            ...
            switch (islem) {
                ...
                case 2:
                    ...
                    anapara -= cekme;
                    System.out.println("Hesabınızdan " + cekme + "₺ Para Çekilmiştir. Hesabınızda " + anapara + "₺ Kalmıştır.");
                    break;
                case 3:
                            ...
                            switch (dolarislem) {
                                case 1:
                                    ...
                                    while (anapara < dolaralis * dolarkuru) {
                                        System.out.println("Hesabınızda Yeterli Miktarda Para Bulunmamaktadır. Hesabınızdan " + anapara / dolarkuru + "$ Alabilirsiniz. Lütfen Almak "
                                                + "İstediğiniz Tutarı Tekrar Giriniz: ");
                                ...
                                case 2:
                                    ...
                                    while (anadolar < dolarsatis) {
                                        System.out.println("Hesabınızda Yeterli Miktarda Para Bulunmamaktadır. Hesabınızdan " + anadolar + "$ Satabilirsiniz. Lütfen Satmak "
                                                + "İstediğiniz Tutarı Tekrar Giriniz: ");
                            ...
                            switch (euroislem) {
                                case 1:
                                    ...
                                    while (anapara < euroalis * eurokuru) {
                                        System.out.println("Hesabınızda Yeterli Miktarda Para Bulunmamaktadır. Hesabınızdan " + anapara / eurokuru + "$ Alabilirsiniz. Lütfen Almak "
                                                + "İstediğiniz Tutarı Tekrar Giriniz: ");
                                ...
                                case 2:
                                    ...
                                    while (anaeuro < eurosatis) {
                                        System.out.println("Hesabınızda Yeterli Miktarda Para Bulunmamaktadır. Hesabınızdan " + anaeuro + "€ Satabilirsiniz. Lütfen Satmak "
                                                + "İstediğiniz Tutarı Tekrar Giriniz: ");
                            ...
                            switch (sterlinislem) {
                                case 1:
                                    ...
                                    while (anapara < sterlinalis * sterlinkuru) {
                                        System.out.println("Hesabınızda Yeterli Miktarda Para Bulunmamaktadır. Hesabınızdan " + anapara / sterlinkuru + "£ Alabilirsiniz. Lütfen Almak "
                                                + "İstediğiniz Tutarı Tekrar Giriniz: ");
                                ...
                                case 2:
                                    ...
                                    while (anasterlin < sterlinsatis) {
                                        System.out.println("Hesabınızda Yeterli Miktarda Para Bulunmamaktadır. Hesabınızdan " + anasterlin + "£ Satabilirsiniz. Lütfen Satmak "
                                                + "İstediğiniz Tutarı Tekrar Giriniz: ");
                                        sterlinalis = scan.nextFloat();
                                    }
                            ...
                            switch (altinislem) {
                                case 1:
                                    ...
                                    while (anapara < altinalis * altinkuru) {
                                        System.out.println("Hesabınızda Yeterli Miktarda Para Bulunmamaktadır. Hesabınızdan " + anapara / altinkuru + " Gram Altın"
                                                + " Alabilirsiniz. Lütfen Almak İstediğiniz Tutarı Tekrar Giriniz: ");
                                ...
                                case 2:
                                    ...
                                    while (anaaltin < altinsatis) {
                                        System.out.println("Hesabınızda Yeterli Miktarda Para Bulunmamaktadır. Hesabınızdan " + anaaltin + " Gram Altın Satabilirsiniz. Lütfen Satmak "
                                                + "İstediğiniz Tutarı Tekrar Giriniz: ");
                    ...
                    switch (kisi) {
                        case 1:
                            ...
                            while (anapara < ahmetpara) {
                                System.out.print("Hesabınızda Yeterli Miktarda Para Bulunmamaktadır. Hesabınızda " + anapara + "₺ Bulunmaktadır. Lütfen Göndermek İstediğiniz Tutarı Tekrar Giriniz: ");
                        ...
                        case 3:
                            ...
                            while (anapara < hulusipara) {
                                System.out.println("Hesabınızda Yeterli Miktarda Para Bulunmamaktadır. Hesabınızda " + anapara + "₺ Bulunmaktadır. Lütfen Göndermek İstediğiniz Tutarı Tekrar Giriniz: ");
